/* app/static/app.js (fs-31)
   - 预览图改用 srcset/sizes，自适应选择 128~512 像素缩略图
   - 图片加载失败自动回退到原始 /media/preview/{id}
   - 其余逻辑与 fs-30 相同（已观看按钮、播放、渐进加载…）
*/
...
async function playIndex(i){
  ...
  try{
    ...
    showNotice("播放被阻止：请点击屏幕以继续播放。"); installUserGestureUnlock();
  }
  renderPlaylistPanel();
}
